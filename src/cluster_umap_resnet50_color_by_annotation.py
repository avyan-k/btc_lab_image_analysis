...
def cluster_and_visualize_images(seed,image_directory, umap_annotation_outpath_path, umap_kmeans_output_path, csv_output_path, pdf_output_path):
    ...
    # UMAP dimension reduction with annotations in legend, uses normalized features_array
